  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M17.593 3.322c1.1.128 1.907 1.077 1.907 2.185V21L12 17.25 4.5 21V5.507c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0 1 11.186 0Z" />
    ...
    <div className=' flex w-[20rem] p-2 justify-between'>
      ...
      <p className='flex items-center gap-2 '>
        <button onClick={handleClick} className='active:transition-all active:scale-125' >
        <svg xmlns="http://www.w3.org/2000/svg" fill="gray" viewBox="0 0 24 24" strokeWidth={1.2} stroke="none" className={`size-5 hover:fill-rose-400 ${isClicked? 'fill-rose-400' : 'fill-gray'}`}>
  <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
</svg>
        </button>
      </p>
