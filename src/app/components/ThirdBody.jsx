...
const ThirdBody = () => {
  return (
    <div className='text-center bg-amber-300 py-[6rem] flex flex-col justify-center items-center'>
      ...
      <p className='mx-10 text-lg mb-[3rem] max-w-[30rem]'>
      ...
      <a className='rounded-full border-1 bg-black p-4'>Get started now</a>
      <a className='border-1 rounded-full bg-white p-4 text-black'>Learn about hiring</a>
      </div>
      <div className='flex flex-row mt-[4rem] text-xl'>
      <p>Are you a designer?</p><a>Join Dribble</a>
      </div>
    </div>
  )
}
