...
const ThirdBody = () => {
  return (
    <div className='text-center bg-amber-300 py-[6rem] flex flex-col justify-center items-center'>
      ...
      <a className='rounded-full border-1 bg-black p-4 font-sans font-semibold'>Get started now</a>
      <a className='border-1 rounded-full bg-white p-4 text-black font-sans font-semibold'>Learn about hiring</a>
      </div>
      <div className='flex flex-row mt-[4rem] text-xl font-sans'>
      <p>Are you a designer?</p><a href='' className=''>Join Dribble</a>
      </div>
    </div>
  )
}
